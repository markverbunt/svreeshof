...
<head>
    ...
    <title>Sv Reeshof Bierteam - Aan / Afmeldingen logs</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Aanmeldingen / afmeldingen logs
                                <small>Een overzicht van alle aanmeldingen / afmeldingen</small>
                            </h2>
                        </div>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr>";
                                            ...
                                            else if($bookings_status=="1") echo "<td><span class='label bg-green'>AANGEMELD</span></td>";
