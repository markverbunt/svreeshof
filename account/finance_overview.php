                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<tr>";
                                                ...
                                                <td><div class='progress'>
                                                        <div class='progress-bar bg-red' role='progressbar' aria-valuenow='$finance' aria-valuemin='0' aria-valuemax='80' style='width: $financeBar%'>&euro; $finance</div>
                                                    </div>
                                                </td>";
                                                }
                                                else if($finance=="0") {echo "
                                                <td><div class='progress'>
                                                        <div class='progress-bar bg-green' role='progressbar' aria-valuenow='$finance' aria-valuemin='0' aria-valuemax='80' style='width: 100%'>&euro; $finance</div>
                                                    </div>
                                                </td>";
                                                }
                                                else {echo"
                                                <td><div class='progress'>
                                                        <div class='progress-bar bg-green' role='progressbar' aria-valuenow='$finance' aria-valuemin='0' aria-valuemax='80' style='width: $financeBar%'>&euro; $finance</div>
                                                    </div>
                                                </td>";
                                                }
